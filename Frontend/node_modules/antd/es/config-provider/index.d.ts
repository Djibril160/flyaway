...
import type { BadgeConfig, ButtonConfig, DrawerConfig, ComponentStyleConfig, ConfigConsumerProps, CSPConfig, DirectionType, FlexConfig, ModalConfig, PopupOverflow, Theme, ThemeConfig, WaveConfig } from 'antd/es/config-provider/context';
